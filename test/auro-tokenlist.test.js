...
describe("auro-tokenlist", () => {
  ...
  it("auro-tokenlist current table displays all componentData", async () => {
    ...
    ).to.contain.text("var(--ds-breakpoint-sm)");
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(2)"),
    ).to.contain.text("660px");
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(3)"),
    ).not.to.contain.text(
      `style="background-color: var(--ds-breakpoint-sm)"></div>`,
    );

    await expect(
      tableBodyRow2.querySelector("td:nth-of-type(1)"),
    ).to.contain.text("var(--ds-breakpoint-md)");
    await expect(
      tableBodyRow2.querySelector("td:nth-of-type(2)"),
    ).to.contain.text("1024px");
    await expect(
      tableBodyRow2.querySelector("td:nth-of-type(3)"),
    ).not.to.contain.text(
      `style="background-color: var(--ds-breakpoint-md)"></style=>`,
    );
  });
  ...
  it("auro-tokenlist current table with swatch displays all componentData", async () => {
    ...
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(1)"),
    ).to.contain.text("var(--ds-color-brand-atlas-100)");
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(2)"),
    ).to.contain.text("#cde6ff");
    const swatch1 = tableBodyRow1.querySelector(
      "td:nth-of-type(3) div.swatch--rectangle",
    );
    await expect(swatch1).to.exist;
    await expect(swatch1.style.background).to.equal(
      "var(--ds-color-brand-atlas-100)",
    );

    await expect(
      tableBodyRow2.querySelector("td:nth-of-type(1)"),
    ).to.contain.text("var(--ds-color-brand-atlas-200)");
    await expect(
      tableBodyRow2.querySelector("td:nth-of-type(2)"),
    ).to.contain.text("#6bb7fb");
    const swatch2 = tableBodyRow2.querySelector(
      "td:nth-of-type(3) div.swatch--rectangle",
    );
    await expect(swatch2).to.exist;
    await expect(swatch2.style.background).to.equal(
      "var(--ds-color-brand-atlas-200)",
    );
  });
  ...
  it("auro-tokenlist current table with swatch circle displays all componentData", async () => {
    ...
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(1)"),
    ).to.contain.text("var(--ds-color-brand-canyon-300)");
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(2)"),
    ).to.contain.text("#f26135");
    const swatch1 = tableBodyRow1.querySelector(
      "td:nth-of-type(3) div.swatch--circle",
    );
    await expect(swatch1).to.exist;
    await expect(swatch1.style.background).to.equal(
      "var(--ds-color-brand-canyon-300)",
    );

    await expect(
      tableBodyRow2.querySelector("td:nth-of-type(1)"),
    ).to.contain.text("var(--ds-color-brand-breeze-100)");
    await expect(
      tableBodyRow2.querySelector("td:nth-of-type(2)"),
    ).to.contain.text("#c0f7ff");
    const swatch2 = tableBodyRow2.querySelector(
      "td:nth-of-type(3) div.swatch--circle",
    );
    await expect(swatch2).to.exist;
    await expect(swatch2.style.background).to.equal(
      "var(--ds-color-brand-breeze-100)",
    );
  });
  ...
  it("auro-tokenlist current table with gradient swatch displays gradient background", async () => {
    ...
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(1)"),
    ).to.contain.text("var(--ds-advanced-color-expanded-widget-background)");
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(2) span.is-gradient"),
    ).to.contain.text(
      "linear-gradient(180deg, rgba(38, 32, 67, 0.65) 0%, rgba(38, 32, 67, 0) 65%), linear-gradient(90deg, #463c8f 25.8%, #ce0c88 100%)",
    );
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(3) div.swatch--rectangle"),
    ).to.have.class("is-gradient");
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(3)"),
    ).to.contain.html(
      `<div class="swatch--rectangle is-gradient" style="background: var(--ds-advanced-color-expanded-widget-background)">`,
    );
  });
  ...
  it("auro-tokenlist deprecated table displays explicit auro currentToken reference", async () => {
    ...
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(2)"),
    ).to.contain.text("var(--ds-color-brand-atlas-400)");
  });
  ...
  it("auro-tokenlist deprecated table displays all componentData", async () => {
    ...
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(1)"),
    ).to.contain.text("var(--color-background-active-button)");
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(2)"),
    ).to.contain.text("n/a");
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(3)"),
    ).to.contain.text("#0064c6");

    await expect(
      tableBodyRow2.querySelector("td:nth-of-type(1)"),
    ).to.contain.text("var(--color-background-is-active-button)");
    await expect(
      tableBodyRow2.querySelector("td:nth-of-type(2)"),
    ).to.contain.text("var(--ds-color-brand-atlas-400)");
    await expect(
      tableBodyRow2.querySelector("td:nth-of-type(3)"),
    ).to.contain.text("#0074cb");
  });
  ...
  it("auro-tokenlist deprecated auro version table displays componentData", async () => {
    ...
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(1)"),
    ).to.contain.text("var(--ds-color-base-gray-100)");
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(2)"),
    ).to.contain.text("var(--ds-color-brand-gray-100)");
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(3)"),
    ).to.contain.text("3.0.1");
    await expect(
      tableBodyRow1.querySelector("td:nth-of-type(4)"),
    ).to.contain.text("#f8f8f8");

    await expect(
      tableBodyRow2.querySelector("td:nth-of-type(1)"),
    ).to.contain.text("var(--ds-color-background-hover-button)");
    await expect(
      tableBodyRow2.querySelector("td:nth-of-type(2)"),
    ).to.contain.text("var(--ds-color-brand-atlas-200)");
    await expect(
      tableBodyRow2.querySelector("td:nth-of-type(3)"),
    ).to.contain.text("2.0.1");
    await expect(
      tableBodyRow2.querySelector("td:nth-of-type(4)"),
    ).to.contain.text("#176cff");
  });
});
