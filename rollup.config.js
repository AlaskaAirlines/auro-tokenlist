...
const legacySwatchListConfig = {
  input: 'src/es5-swatch-list.js',
  output: {
    format: 'iife',
    file: 'dist/auro-swatch-list__bundled.es5.js'
  },
  plugins: getSharedPlugins(true)
};

const legacyColorAvatarConfig = {
  input: 'src/es5-color-avatar.js',
  output: {
    format: 'iife',
    file: 'dist/auro-swatch-list__bundled.es5.js'
  },
...
const legacyTokensListConfig = {
  input: 'src/es5-tokens-list.js',
  output: {
    format: 'iife',
    file: 'dist/auro-swatch-list__bundled.es5.js'
  },
...
export default [
  modernConfig,
  legacySwatchListConfig,
  legacyColorAvatarConfig,
  legacyTokensListConfig
];
